...
var require_is_arrayish = __commonJS({
  "../../../node_modules/.pnpm/is-arrayish@0.3.2/node_modules/is-arrayish/index.js"(exports, module) {
    module.exports = function isArrayish3(obj) {
...
var require_simple_swizzle = __commonJS({
  "../../../node_modules/.pnpm/simple-swizzle@0.2.2/node_modules/simple-swizzle/index.js"(exports, module) {
    "use strict";
    var isArrayish3 = require_is_arrayish();
...
var require_conversions = __commonJS({
  "../../../node_modules/.pnpm/color-convert@2.0.1/node_modules/color-convert/conversions.js"(exports, module) {
    ...
    for (const key of Object.keys(cssKeywords)) {
      reverseKeywords2[cssKeywords[key]] = key;
    }
    var convert2 = {
    ...
    convert2.rgb.keyword = function(rgb) {
      const reversed = reverseKeywords2[rgb];
      if (reversed) {
        return reversed;
      }
      ...
      for (const keyword of Object.keys(cssKeywords)) {
        ...
        const distance = comparativeDistance2(rgb, value);
...
var require_route = __commonJS({
  "../../../node_modules/.pnpm/color-convert@2.0.1/node_modules/color-convert/route.js"(exports, module) {
    ...
    function wrapConversion2(toModel, graph) {
    ...
    module.exports = function(fromModel) {
      const graph = deriveBFS2(fromModel);
      const conversion = {};
      ...
      for (let len = models2.length, i = 0; i < len; i++) {
        ...
        conversion[toModel] = wrapConversion2(toModel, graph);
      }
      return conversion;
    };
  }
...
var require_color_convert = __commonJS({
  "../../../node_modules/.pnpm/color-convert@2.0.1/node_modules/color-convert/index.js"(exports, module) {
    ...
    var convert2 = {};
    var models2 = Object.keys(conversions2);
    function wrapRaw2(fn) {
    ...
    models2.forEach((fromModel) => {
      ...
      routeModels.forEach((toModel) => {
        ...
        convert2[fromModel][toModel] = wrapRounded2(fn);
        convert2[fromModel][toModel].raw = wrapRaw2(fn);
      });
    });
    module.exports = convert2;
  }
...
var require_color = __commonJS({
  "../../../node_modules/.pnpm/color@4.2.3/node_modules/color/index.js"(exports, module) {
    var colorString2 = require_color_string();
    ...
    var hashedModelKeys2 = {};
    for (const model of Object.keys(convert2)) {
      hashedModelKeys2[[...convert2[model].labels].sort().join("")] = model;
    }
    var limiters2 = {};
    function Color2(object, model) {
      ...
      if (model && model in skippedModels2) {
        model = null;
      }
      ...
      if (object == null) {
        ...
        this.color = zeroArray2(newArray, channels);
        ...
        if (!(hashedKeys in hashedModelKeys2)) {
          throw new Error("Unable to parse color from object: " + JSON.stringify(object));
        }
        this.model = hashedModelKeys2[hashedKeys];
      ...
      if (limiters2[this.model]) {
        channels = convert2[this.model].channels;
        for (i = 0; i < channels; i++) {
          const limit = limiters2[this.model][i];
          if (limit) {
    ...
    Color2.prototype = {
      ...
      string(places) {
        let self = this.model in colorString2.to ? this : this.rgb();
        self = self.round(typeof places === "number" ? places : 1);
        const args = self.valpha === 1 ? self.color : [...self.color, this.valpha];
        return colorString2.to[self.model](args);
      },
      ...
      round(places) {
        ...
        return new Color2([...this.color.map(roundToPlace2(places)), this.valpha], this.model);
      },
      alpha(value) {
        if (value !== void 0) {
      ...
      red: getset2("rgb", 0, maxfn2(255)),
      green: getset2("rgb", 1, maxfn2(255)),
      blue: getset2("rgb", 2, maxfn2(255)),
      hue: getset2(["hsl", "hsv", "hsl", "hwb", "hcg"], 0, (value) => (value % 360 + 360) % 360),
      saturationl: getset2("hsl", 1, maxfn2(100)),
      lightness: getset2("hsl", 2, maxfn2(100)),
      saturationv: getset2("hsv", 1, maxfn2(100)),
      value: getset2("hsv", 2, maxfn2(100)),
      chroma: getset2("hcg", 1, maxfn2(100)),
      gray: getset2("hcg", 2, maxfn2(100)),
      white: getset2("hwb", 1, maxfn2(100)),
      wblack: getset2("hwb", 2, maxfn2(100)),
      cyan: getset2("cmyk", 0, maxfn2(100)),
      magenta: getset2("cmyk", 1, maxfn2(100)),
      yellow: getset2("cmyk", 2, maxfn2(100)),
      black: getset2("cmyk", 3, maxfn2(100)),
      x: getset2("xyz", 0, maxfn2(95.047)),
      y: getset2("xyz", 1, maxfn2(100)),
      z: getset2("xyz", 2, maxfn2(108.833)),
      l: getset2("lab", 0, maxfn2(100)),
      a: getset2("lab", 1),
      b: getset2("lab", 2),
      keyword(value) {
        if (value !== void 0) {
    ...
    for (const model of Object.keys(convert2)) {
      if (skippedModels2.includes(model)) {
        continue;
      }
      ...
      Color2.prototype[model] = function(...args) {
        ...
        return new Color2([...assertArray2(convert2[this.model][model].raw(this.color)), this.valpha], model);
      };
      Color2[model] = function(...args) {
        let color2 = args[0];
        if (typeof color2 === "number") {
          color2 = zeroArray2(args, channels);
        }
    ...
    function roundToPlace2(places) {
      return function(number) {
        return roundTo2(number, places);
      };
    }
    function getset2(model, channel, modifier) {
      model = Array.isArray(model) ? model : [model];
      for (const m of model) {
        (limiters2[m] || (limiters2[m] = []))[channel] = modifier;
      }
      model = model[0];
    ...
    function assertArray2(value) {
      return Array.isArray(value) ? value : [value];
    }
    function zeroArray2(array, length) {
...
// ../../../node_modules/.pnpm/@kviewui+color-builder@1.0.5/node_modules/@kviewui/color-builder/lib/index.esm.js
...
var colorPresetPanel = {
  ...
  deepblue: getPresetColor("deepblue"),
...
var colorPresetData = {
  "red": _nullishCoalesce(config.colorPresetPanel.red, () => ( colorPresetPanel.red)),
  "orangered": _nullishCoalesce(config.colorPresetPanel.orangered, () => ( colorPresetPanel.orangered)),
  "orange": _nullishCoalesce(config.colorPresetPanel.orange, () => ( colorPresetPanel.orange)),
  "gold": _nullishCoalesce(config.colorPresetPanel.gold, () => ( colorPresetPanel.gold)),
  "yellow": _nullishCoalesce(config.colorPresetPanel.yellow, () => ( colorPresetPanel.yellow)),
  "lime": _nullishCoalesce(config.colorPresetPanel.lime, () => ( colorPresetPanel.lime)),
  "green": _nullishCoalesce(config.colorPresetPanel.green, () => ( colorPresetPanel.green)),
  "brandgreen": _nullishCoalesce(config.colorPresetPanel.brandgreen, () => ( colorPresetPanel.brandgreen)),
  "cyan": _nullishCoalesce(config.colorPresetPanel.cyan, () => ( colorPresetPanel.cyan)),
  "blue": _nullishCoalesce(config.colorPresetPanel.blue, () => ( colorPresetPanel.blue)),
  "deepblue": _nullishCoalesce(config.colorPresetPanel.deepblue, () => ( colorPresetPanel.deepblue)),
  "purple": _nullishCoalesce(config.colorPresetPanel.purple, () => ( colorPresetPanel.purple)),
  "pinkpurple": _nullishCoalesce(config.colorPresetPanel.pinkpurple, () => ( colorPresetPanel.pinkpurple)),
  "magenta": _nullishCoalesce(config.colorPresetPanel.magenta, () => ( colorPresetPanel.magenta)),
  "grey": _nullishCoalesce(config.colorPresetPanel.grey, () => ( colorPresetPanel.grey)),
  "primary": _nullishCoalesce(config.colorPresetPanel.primary, () => ( colorPresetPanel.primary)),
  "success": _nullishCoalesce(config.colorPresetPanel.success, () => ( colorPresetPanel.success)),
  "danger": _nullishCoalesce(config.colorPresetPanel.danger, () => ( colorPresetPanel.danger)),
  "warning": _nullishCoalesce(config.colorPresetPanel.warning, () => ( colorPresetPanel.warning)),
  "link": _nullishCoalesce(config.colorPresetPanel.link, () => ( colorPresetPanel.link)),
  "info": _nullishCoalesce(config.colorPresetPanel.info, () => ( colorPresetPanel.info))
};
...
var darken = (colorString2, alpha = 0.2) => {
  const Color2 = require_color();
  const color2 = Color2(colorString2);
  const isDarken = color2.isDark();
  if (isDarken)
    return color2.lighten(alpha);
  return color2.darken(alpha);
  return isDarken ? color2.lighten(alpha) : new Color2(color2).darken(alpha);
  return "";
};
var colors = {
...
exports.theme = theme; exports.timingFunctionMap = timingFunctionMap;
