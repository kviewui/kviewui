...
(function(vue) {
  ...
  var PatchFlagNames, slotFlagsText, GLOBALS_WHITE_LISTED, isGloballyWhitelisted, range, listDelimiterRE, propertyDelimiterRE, styleCommentRE, HTML_TAGS, SVG_TAGS, VOID_TAGS, isHTMLTag, isSVGTag, isVoidTag, specialBooleanAttrs, isSpecialBooleanAttr, isBooleanAttr, unsafeAttrCharRE, attrValidationCache, propsToAttrMap, isKnownHtmlAttr, isKnownSvgAttr, escapeRE, commentStripRE, toDisplayString, replacer, EMPTY_OBJ, EMPTY_ARR, NOOP, NO, onRE, isOn, isModelListener, extend, remove, hasOwnProperty$1, hasOwn, isArray, isMap, isSet, isDate, isFunction, isString, isSymbol, isObject, isPromise, objectToString, toTypeString, toRawType, isPlainObject, isIntegerKey, isReservedProp, isBuiltInDirective, cacheStringFunction, camelizeRE, camelize, hyphenateRE, hyphenate, capitalize, toHandlerKey, hasChanged, invokeArrayFns, def, toNumber, _globalThis, getGlobalThis, identRE;
...
Component that was made reactive: `, type);
  ...
  function validateComponentName(name2, config3) {
...
${codeFrame}` : message);
  ...
  var createComponent = (name2) => {
    const componentName2 = `kui-${name2}`;
    return {
      componentName: componentName2,
      create: function(componentOptions) {
        componentOptions.name = componentName2;
  ...
  var simpleSwizzle$1 = createCommonjsModule(function(module) {
    var concat2 = Array.prototype.concat;
    var slice2 = Array.prototype.slice;
    var swizzle2 = module.exports = function swizzle3(args) {
      var results = [];
    ...
    swizzle2.wrap = function(fn) {
      return function() {
        return fn(swizzle2(arguments));
      };
    };
  });
  var colorString$2 = createCommonjsModule(function(module) {
  ...
  const generate = (color2, options = {
    ...
    return dark ? colorPaletteDark(color2, index, format) : colorPalette$1(color2, index, format);
  };
  const colorList = {
    red: "#F53F3F",
    orangered: "#F77234",
  ...
  const colorPalette = (color2, index, dark = false) => {
  ...
  const { componentName, create: create$6 } = createComponent("button");
  ...
  function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "kui-box-border kui-flex kui-items-start" }, [
      vue.createElementVNode("button", {
        class: vue.normalizeClass(["kui-flex", _ctx.shadow ? `kui-shadow-${_ctx.shadowSize}` : ""]),
        plain: true,
        disabled: _ctx.disabled,
        style: vue.normalizeStyle(_ctx.btnStyle),
      ...
      ], 46, ["disabled", "form-type", "open-type", "hover-class", "hover-start-time", "hover-stay-time", "app-parameter", "hover-stop-propagation", "lang", "session-from", "send-message-title", "send-message-path", "send-message-img", "show-message-card"])
    ]);
  }
  const Button = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__scopeId", "data-v-68f92122"], ["__file", "E:/work/kviewui/src/packages/components/src/button/index.vue"]]);
  const pageProps = {
    bgColor: {
      type: String,
      default: ""
  ...
  const Page = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__scopeId", "data-v-9a10cdcc"], ["__file", "E:/work/kviewui/src/packages/components/src/page/index.vue"]]);
  const imageProps = {
    src: {
      type: String,
      default: ""
  ...
  const Image = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__scopeId", "data-v-50ce88ea"], ["__file", "E:/work/kviewui/src/packages/components/src/image/index.vue"]]);
  const textProps = {
    mode: {
      type: String,
      default: () => {
  ...
  const _sfc_main$4 = create$3({
    ...
    setup(props) {
      ...
      const changeMode = (e) => {
        ...
        const colorMap = theme2.colors[e][props.color] ? theme2.colors[e][props.color] : colorBuilder.generate(color2, { dark: isDark, list: true });
  ...
  const Text = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__file", "E:/work/kviewui/src/packages/components/src/text/index.vue"]]);
  ...
  function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", {
      class: vue.normalizeClass([[_ctx.customClass], "kui-container kui-flex kui-flex-col kui-flex-1"]),
      style: vue.normalizeStyle({
        width: _ctx.width,
        height: _ctx.height,
  ...
  const Container = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__file", "E:/work/kviewui/src/packages/components/src/container/index.vue"]]);
  ...
  const Animation = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__scopeId", "data-v-c768d236"], ["__file", "E:/work/kviewui/src/packages/components/src/animation/index.vue"]]);
  const switchProps = {
    modelValue: {
      type: Boolean,
      default: false
  ...
  const _sfc_main$1 = create({
    ...
    setup(props, { emit: emit2 }) {
      ...
      const activeIconColorMap = theme2.colors[props.mode][props.iconColor] ? theme2.colors[props.mode][props.iconColor] : colorBuilder.generate(props.iconColor, { dark: rootState.isDark, list: true });
      ...
      const rootStyle = vue.computed(() => {
        ...
        style.width = "72rpx";
        style.height = "42rpx";
        const activeColorMap = theme2.colors[props.mode][props.activeColor] ? theme2.colors[props.mode][props.activeColor] : colorBuilder.generate(props.activeColor, { dark: rootState.isDark, list: true });
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_kui_animation = vue.resolveComponent("kui-animation");
    ...
    return vue.openBlock(), vue.createElementBlock("view", {
      ...
      vue.createElementVNode("view", {
        ...
        _ctx.rootState.loading ? (vue.openBlock(), vue.createBlock(_component_kui_animation, {
          key: 0,
          name: "rotate-center",
          duration: 1,
          runing: "",
          ...
          default: vue.withCtx(() => [
            vue.createCommentVNode(' <kui-icons :size="iconState.size" :color="iconState.color" type="spinner6"></kui-icons> ')
          ]),
          _: 1
  ...
  const Switch = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__scopeId", "data-v-f2e8e81e"], ["__file", "E:/work/kviewui/src/packages/components/src/switch/index.vue"]]);
  ...
  function createApp() {
    ...
    app2.provide("$kView", KviewUIConfig);
    return {
      app: app2
    };
  }
