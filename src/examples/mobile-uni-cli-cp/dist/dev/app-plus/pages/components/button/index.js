...
(() => {
  ...
  // dist/dev/.nvue/pages/components/button/index.js
...
${codeFrame}` : message);
  ...
  var { create: create$3 } = createComponent("icon");
  var _sfc_main$6 = create$3({
    props: iconProps,
    setup(props) {
  ...
  var _style_0$2 = { "kui-icons": { "": { "fontFamily": "kui-icons", "textDecoration": "none" } } };
  ...
  var KuiIcons = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["styles", [_style_0$2]], ["__file", "E:/work/kviewui/src/packages/components/src/icons/index.vue"]]);
  var buttonProps = {
    type: {
      type: String,
      default: ""
  ...
  var _sfc_main$5 = (0, import_vue.defineComponent)({
    ...
    setup(props, context) {
      ...
      const elId = getElId();
      const buttonWrap = (0, import_vue.ref)(null);
      ...
      const getSpaceInstance = () => {
        return (0, import_vue.inject)("spaceComponent");
      };
      let parentSpace;
      parentSpace = (0, import_vue.getCurrentInstance)().proxy.$parent;
      (0, import_vue.onMounted)(() => {
        if (getSpaceInstance()) {
          const spaceIns = getSpaceInstance();
          useKviewuiRect(buttonWrap, elId, proxy).then((element) => {
            const pushItem = __spreadValues(__spreadValues({}, (0, import_vue.toRefs)(data)), element);
      ...
      const style = (0, import_vue.reactive)({});
      const btnStyle = (0, import_vue.computed)(() => {
  ...
  function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_kui_icons = (0, import_vue.resolveComponent)("kui-icons");
    ...
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
      ...
      (0, import_vue.createVNode)(_component_button, {
        "render-whole": true,
        class: (0, import_vue.normalizeClass)(["kui-flex kui-leading-none kui-items-center", [_ctx.data.shadowClass]]),
        ...
        default: (0, import_vue.withCtx)(() => [
          (0, import_vue.createElementVNode)("view", {
            ...
            _ctx.loading ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
              key: 0,
              class: (0, import_vue.normalizeClass)(["kui-relative", [_ctx.content ? "kui-mr-1" : ""]]),
              style: (0, import_vue.normalizeStyle)({
                right: `${_ctx.$slots.default ? 10 : 0}rpx`
              })
            }, [
              (0, import_vue.createCommentVNode)(' <kui-spin :width="55" :height="55" :type="loadingType" :scale="0.7" :background-color="data.color"></kui-spin> '),
              (0, import_vue.createVNode)(_component_kui_icons, {
                color: _ctx.data.color,
                name: "spinner3"
              }, null, 8, ["color"])
            ], 6)) : (0, import_vue.createCommentVNode)("v-if", true),
            _ctx.icon ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
              key: 1,
              class: (0, import_vue.normalizeClass)(_ctx.$slots.default ? "kui-mr-1" : "")
            }, [
              (0, import_vue.createCommentVNode)(' <kui-icons :type="icon" :color="data.color" :weight="800" :size="40"></kui-icons> ')
            ...
            (0, import_vue.createElementVNode)("view", { class: "" }, [
              (0, import_vue.renderSlot)(_ctx.$slots, "default", {}, () => [
                ...
                }, (0, import_vue.toDisplayString)(_ctx.content), 5)
              ]),
        ...
        _: 3
      }, 8, ["class", "elevation", "disabled", "style", "form-type", "open-type", "hover-class", "hover-start-time", "hover-stay-time", "app-parameter", "hover-stop-propagation", "lang", "session-from", "send-message-title", "send-message-path", "send-message-img", "show-message-card", "onTouchstart", "onTouchend", "onClick", "onGetphonenumber", "onGetuserinfo", "onError", "onOpensetting", "onLaunchapp"])
    ], 8, ["id"]);
  }
  var KuiButton = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__file", "E:/work/kviewui/src/packages/components/src/button/index.vue"]]);
  var spaceProps = {
    justify: {
      type: String,
      default: "flex-start"
  ...
  var KuiSpace = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["styles", [_style_0$1]], ["__file", "E:/work/kviewui/src/packages/components/src/space/index.vue"]]);
  var pageProps = {
    bgColor: {
      type: String,
      default: ""
  ...
  var KuiPage = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["styles", [_style_0]], ["__file", "E:/work/kviewui/src/packages/components/src/page/index.vue"]]);
  var { create: create$1 } = createComponent("config-provider");
  var _sfc_main$2 = create$1({
    props: configProviderProps,
    emits: ["update:mode"],
    setup(props, { slots, emit: emit2 }) {
      let config = (0, import_vue.reactive)({
        mode: props.mode,
        color: props.color,
        fontSize: props.fontSize
      });
      (0, import_vue.provide)(configProviderInjectionKey, config);
      uni.$on("changeMode", (e) => {
        config.mode = e;
        (0, import_vue.provide)(configProviderInjectionKey, config);
      });
  ...
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, import_vue.renderSlot)(_ctx.$slots, "default");
  }
  var KuiConfigProvider = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__file", "E:/work/kviewui/src/packages/components/src/config-provider/index.vue"]]);
  ...
  var isArrayish3 = function isArrayish22(obj) {
    if (!obj || typeof obj === "string") {
      return false;
    }
    return obj instanceof Array || Array.isArray(obj) || obj.length >= 0 && (obj.splice instanceof Function || Object.getOwnPropertyDescriptor(obj, obj.length - 1) && obj.constructor.name !== "String");
  ...
  var { create } = createComponent("cell-group");
  ...
  var KuiCellGroup = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "E:/work/kviewui/src/packages/components/src/cell-group/index.vue"]]);
  var _sfc_main = /* @__PURE__ */ (0, import_vue.defineComponent)({
    __name: "index",
    setup(__props) {
      const taped = () => {
        formatAppLog("log", "at pages/components/button/index.nvue:162", 22222);
      };
      return (_ctx, _cache) => {
        return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("scroll-view", {
          ...
          (0, import_vue.createVNode)(KuiPage, { customHeader: false }, {
            body: (0, import_vue.withCtx)(() => [
              (0, import_vue.createElementVNode)("view", { class: "kui-mt-3" }, [
                (0, import_vue.createVNode)(KuiIcons, { name: "pingguo" }),
                (0, import_vue.createVNode)(KuiConfigProvider, {
                  "font-size": "18px",
                  color: "#666"
                }, {
                  default: (0, import_vue.withCtx)(() => [
                    (0, import_vue.createElementVNode)("view", { class: "kui-flex-col kui-h-full kui-w-full1" }, [
                      (0, import_vue.createVNode)(KuiCellGroup, { title: "\u6E10\u53D8\u6309\u94AE" }, {
                        default: (0, import_vue.withCtx)(() => [
                          (0, import_vue.createElementVNode)("view", { class: "kui-mt-0" }, [
                            (0, import_vue.createVNode)(KuiSpace, { gap: [20, 10] }, {
                              default: (0, import_vue.withCtx)(() => [
                                (0, import_vue.createVNode)(KuiButton, {
                                  content: "\u4E3B\u8981\u6309\u94AE",
                                  onClick: taped,
                                  type: "primary"
                                }),
                                ...
                                (0, import_vue.createVNode)(KuiButton, { content: "\u9ED8\u8BA4\u6309\u94AE" }),
                                (0, import_vue.createVNode)(KuiButton, {
                                  content: "\u6210\u529F\u6309\u94AE",
                                  type: "success"
                                }),
                      ...
                      (0, import_vue.createVNode)(KuiCellGroup, {
                        title: "\u6587\u672C\u6309\u94AE",
                        "custom-class": "kui-mt-6"
                      }, {
                        default: (0, import_vue.withCtx)(() => [
                          (0, import_vue.createElementVNode)("view", { class: "kui-mt-0" }, [
                            (0, import_vue.createVNode)(KuiSpace, { gap: [20, 10] }, {
                            ...
                            (0, import_vue.createVNode)(KuiSpace, { gap: [20, 10] }, {
                              default: (0, import_vue.withCtx)(() => [
                                (0, import_vue.createVNode)(KuiButton, {
                                  ...
                                  default: (0, import_vue.withCtx)(() => [
                                    (0, import_vue.createCommentVNode)(' <kui-icons name="plus-round" :size="40" /> ')
                                  ]),
                                  _: 1
                                }),
                                (0, import_vue.createVNode)(KuiButton, {
                                  ...
                                  default: (0, import_vue.withCtx)(() => [
                                    (0, import_vue.createCommentVNode)(' <kui-icons name="android-alert" :size="50" :top="2" /> ')
                                  ]),
                                  _: 1
                                }),
                                (0, import_vue.createVNode)(KuiButton, {
                                  ...
                                  default: (0, import_vue.withCtx)(() => [
                                    (0, import_vue.createCommentVNode)(' <kui-icons name="checkmark-round" :size="40" /> ')
                                  ]),
                                  _: 1
                                }),
                                (0, import_vue.createVNode)(KuiButton, {
                                  ...
                                  default: (0, import_vue.withCtx)(() => [
                                    (0, import_vue.createCommentVNode)(' <kui-icons name="alert-circled" :size="50" :top="-3" /> ')
                                  ]),
                                  _: 1
                                }),
                                (0, import_vue.createVNode)(KuiButton, {
                                  ...
                                  default: (0, import_vue.withCtx)(() => [
                                    (0, import_vue.createCommentVNode)(' <kui-icons name="close" :size="50" :top="-1" /> ')
                                  ]),
                                  _: 1
                                })
                              ]),
                      ...
                      (0, import_vue.createVNode)(KuiCellGroup, {
                        ...
                        default: (0, import_vue.withCtx)(() => [
                          (0, import_vue.createElementVNode)("view", { class: "kui-mt-0" }, [
                            (0, import_vue.createCommentVNode)(' <kui-icon name="code" /> '),
                            (0, import_vue.createCommentVNode)(' <kui-icon name="right" :size="16" color="#999" :weight="100"></kui-icon> '),
                            (0, import_vue.createVNode)(KuiSpace, { gap: [20, 10] }, {
                              default: (0, import_vue.withCtx)(() => [
                                (0, import_vue.createVNode)(KuiButton, {
                                  type: "primary",
                      ...
                      (0, import_vue.createVNode)(KuiCellGroup, {
                        ...
                        default: (0, import_vue.withCtx)(() => [
                          (0, import_vue.createElementVNode)("view", { class: "kui-mt-0" }, [
                            (0, import_vue.createVNode)(KuiSpace, {
                              align: "center",
                              gap: [20, 10]
                            }, {
                              default: (0, import_vue.withCtx)(() => [
                      ...
                      (0, import_vue.createVNode)(KuiCellGroup, {
                        title: "\u9632\u6296\u8282\u6D41\uFF08\u5B9E\u9645\u6548\u679C\u8BF7\u67E5\u770B\u63A7\u5236\u53F0\uFF09",
                        "custom-class": "kui-mt-3"
                      }, {
                        default: (0, import_vue.withCtx)(() => [
                          (0, import_vue.createElementVNode)("view", { class: "kui-mt-0" }, [
                            (0, import_vue.createVNode)(KuiSpace, { gap: [20, 10] }, {
  ...
  var index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "E:/work/kviewui/src/examples/mobile-uni-cli/src/pages/components/button/index.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/components/button/index";
    let __pageQuery = {};
    try {
