...
(() => {
    ...
    if (from && typeof from === "object" || typeof from === "function") {
      for (let key of __getOwnPropNames2(from))
        if (!__hasOwnProp2.call(to, key) && key !== except)
          __defProp$1(to, key, { get: () => from[key], enumerable: !(desc = __getOwnPropDesc2(from, key)) || desc.enumerable });
    }
    return to;
  };
  ...
  var __toCommonJS = (mod) => __copyProps2(__defProp$1({}, "__esModule", { value: true }), mod);
...
If you want to remount the same app, move your app creation logic into a factory function and create fresh app instances for each mount - e.g. \`const createMyApp = () => createApp(App)\``);
  ...
  function setRef(rawRef, oldRawRef, parentSuspense, vnode, isUnmount = false) {
    ...
    if (isFunction(ref22)) {
      callWithErrorHandling(ref22, owner, 12, [value, refs]);
    } else {
      const _isString = isString(ref22);
      const _isRef = isRef(ref22);
      if (_isString || _isRef) {
        const doSet = () => {
          if (rawRef.f) {
            const existing = _isString ? hasOwn(setupState, ref22) ? setupState[ref22] : refs[ref22] : ref22.value;
            if (isUnmount) {
              ...
              if (!isArray(existing)) {
                if (_isString) {
                  refs[ref22] = [refValue];
                  if (hasOwn(setupState, ref22)) {
                    setupState[ref22] = refs[ref22];
                  }
                } else {
                  ref22.value = [refValue];
                  if (rawRef.k)
                    refs[rawRef.k] = ref22.value;
                }
            ...
            warn2("Invalid template ref type:", ref22, `(${typeof ref22})`);
          }
        };
        if (value) {
          doSet.id = -1;
  ...
  function createHydrationFunctions(rendererInternals) {
    ...
    const hydrateNode = (node, vnode, parentComponent, parentSuspense, slotScopeIds, optimized = false) => {
      ...
      const { type, ref: ref22, shapeFlag, patchFlag } = vnode;
...
- Server: ${JSON.stringify(vnode.children)}`);
      ...
      if (ref22 != null) {
        setRef(ref22, null, parentSuspense, vnode);
      }
      return nextNode;
    };
...
For more details, see https://link.vuejs.org/feature-flags.`);
  ...
  function baseCreateRenderer(options, createHydrationFns) {
    ...
    const patch = (n1, n2, container, anchor = null, parentComponent = null, parentSuspense = null, isSVG = false, slotScopeIds = null, optimized = isHmrUpdating ? false : !!n2.dynamicChildren) => {
      ...
      const { type, ref: ref22, shapeFlag } = n2;
      switch (type) {
        case Text:
      ...
      if (ref22 != null && parentComponent) {
        setRef(ref22, n1 && n1.ref, parentSuspense, n2 || n1, !n2);
      }
    };
    ...
    const unmount = (vnode, parentComponent, parentSuspense, doRemove = false, optimized = false) => {
      const { type, props, ref: ref22, children, dynamicChildren, shapeFlag, patchFlag, dirs } = vnode;
      if (ref22 != null) {
        setRef(ref22, null, parentSuspense, vnode, true);
      }
      if (shapeFlag & 256) {
...
Component that was made reactive: `, type);
  ...
  function cloneVNode(vnode, extraProps, mergeRef = false) {
    const { props, ref: ref22, patchFlag, children } = vnode;
    ...
    const cloned = {
      ...
      ref: extraProps && extraProps.ref ? mergeRef && ref22 ? isArray(ref22) ? ref22.concat(normalizeRef(extraProps)) : [ref22, normalizeRef(extraProps)] : normalizeRef(extraProps) : ref22,
  ...
  var init_runtime_core_esm_bundler = __esm({
    "../../../node_modules/.pnpm/@vue+runtime-core@3.2.45/node_modules/@vue/runtime-core/dist/runtime-core.esm-bundler.js"() {
      ...
      normalizeRef = ({ ref: ref22, ref_key, ref_for }) => {
        return ref22 != null ? isString(ref22) || isRef(ref22) || isFunction(ref22) ? { i: currentRenderingInstance, r: ref22, k: ref_key, f: !!ref_for } : ref22 : null;
      };
...
${codeFrame}` : message);
  ...
  var isArrayish$2 = function isArrayish2(obj) {
    if (!obj || typeof obj === "string") {
      return false;
    }
    return obj instanceof Array || Array.isArray(obj) || obj.length >= 0 && (obj.splice instanceof Function || Object.getOwnPropertyDescriptor(obj, obj.length - 1) && obj.constructor.name !== "String");
  };
  var simpleSwizzle$2 = createCommonjsModule$2(function(module) {
  ...
  var colorString$2 = createCommonjsModule$2(function(module) {
    var hasOwnProperty2 = Object.hasOwnProperty;
    var reverseNames = /* @__PURE__ */ Object.create(null);
    for (var name2 in colorName$1$2) {
      if (hasOwnProperty2.call(colorName$1$2, name2)) {
        reverseNames[colorName$1$2[name2]] = name2;
      }
    }
    ...
    cs.get.rgb = function(string) {
      ...
      if (match = string.match(hex)) {
        ...
        if (!hasOwnProperty2.call(colorName$1$2, match[1])) {
          return null;
        }
        rgb = colorName$1$2[match[1]];
        rgb[3] = 1;
        return rgb;
      } else {
        return null;
  ...
  var reverseKeywords$2 = {};
  for (const key of Object.keys(colorName$3)) {
    reverseKeywords$2[colorName$3[key]] = key;
  }
  var convert$1$2 = {
  ...
  var conversions$2 = convert$1$2;
  for (const model of Object.keys(convert$1$2)) {
    if (!("channels" in convert$1$2[model])) {
      throw new Error("missing channels property: " + model);
    }
    if (!("labels" in convert$1$2[model])) {
      throw new Error("missing channel labels property: " + model);
    }
    if (convert$1$2[model].labels.length !== convert$1$2[model].channels) {
      throw new Error("channel and label counts mismatch: " + model);
    }
    const { channels, labels } = convert$1$2[model];
    delete convert$1$2[model].channels;
    delete convert$1$2[model].labels;
    Object.defineProperty(convert$1$2[model], "channels", { value: channels });
    Object.defineProperty(convert$1$2[model], "labels", { value: labels });
  }
  convert$1$2.rgb.hsl = function(rgb) {
    const r = rgb[0] / 255;
    const g = rgb[1] / 255;
    const b = rgb[2] / 255;
  ...
  convert$1$2.rgb.hsv = function(rgb) {
    let rdif;
    let gdif;
    let bdif;
    let h2;
  ...
  convert$1$2.rgb.hwb = function(rgb) {
    const r = rgb[0];
    const g = rgb[1];
    let b = rgb[2];
    const h2 = convert$1$2.rgb.hsl(rgb)[0];
    const w = 1 / 255 * Math.min(r, Math.min(g, b));
    b = 1 - 1 / 255 * Math.max(r, Math.max(g, b));
    return [h2, w * 100, b * 100];
  };
  convert$1$2.rgb.cmyk = function(rgb) {
    const r = rgb[0] / 255;
    const g = rgb[1] / 255;
    const b = rgb[2] / 255;
  ...
  convert$1$2.rgb.keyword = function(rgb) {
    ...
    for (const keyword of Object.keys(colorName$3)) {
      const value = colorName$3[keyword];
      const distance = comparativeDistance$2(rgb, value);
  ...
  convert$1$2.keyword.rgb = function(keyword) {
    return colorName$3[keyword];
  };
  convert$1$2.rgb.xyz = function(rgb) {
    let r = rgb[0] / 255;
    let g = rgb[1] / 255;
    let b = rgb[2] / 255;
  ...
  convert$1$2.rgb.lab = function(rgb) {
    const xyz = convert$1$2.rgb.xyz(rgb);
    let x = xyz[0];
    let y = xyz[1];
    let z = xyz[2];
    x /= 95.047;
  ...
  convert$1$2.hsl.rgb = function(hsl) {
    const h2 = hsl[0] / 360;
    const s = hsl[1] / 100;
    const l = hsl[2] / 100;
    let t2;
  ...
  convert$1$2.hsl.hsv = function(hsl) {
    const h2 = hsl[0];
    let s = hsl[1] / 100;
    let l = hsl[2] / 100;
    let smin = s;
  ...
  convert$1$2.hsv.rgb = function(hsv) {
    const h2 = hsv[0] / 60;
    const s = hsv[1] / 100;
    let v = hsv[2] / 100;
  ...
  convert$1$2.hsv.hsl = function(hsv) {
    const h2 = hsv[0];
    const s = hsv[1] / 100;
    const v = hsv[2] / 100;
  ...
  convert$1$2.hwb.rgb = function(hwb) {
    const h2 = hwb[0] / 360;
    let wh = hwb[1] / 100;
    let bl = hwb[2] / 100;
    const ratio = wh + bl;
  ...
  convert$1$2.cmyk.rgb = function(cmyk) {
    const c = cmyk[0] / 100;
    const m = cmyk[1] / 100;
    const y = cmyk[2] / 100;
    const k = cmyk[3] / 100;
  ...
  convert$1$2.xyz.rgb = function(xyz) {
    const x = xyz[0] / 100;
    const y = xyz[1] / 100;
    const z = xyz[2] / 100;
    let r;
  ...
  convert$1$2.xyz.lab = function(xyz) {
    let x = xyz[0];
    let y = xyz[1];
    let z = xyz[2];
    x /= 95.047;
  ...
  convert$1$2.lab.xyz = function(lab) {
    const l = lab[0];
    const a = lab[1];
    const b = lab[2];
    let x;
  ...
  convert$1$2.lab.lch = function(lab) {
    const l = lab[0];
    const a = lab[1];
    const b = lab[2];
    let h2;
  ...
  convert$1$2.lch.lab = function(lch) {
    const l = lch[0];
    const c = lch[1];
    const h2 = lch[2];
  ...
  convert$1$2.rgb.ansi16 = function(args, saturation = null) {
    const [r, g, b] = args;
    let value = saturation === null ? convert$1$2.rgb.hsv(args)[2] : saturation;
  ...
  convert$1$2.hsv.ansi16 = function(args) {
    return convert$1$2.rgb.ansi16(convert$1$2.hsv.rgb(args), args[2]);
  };
  convert$1$2.rgb.ansi256 = function(args) {
    const r = args[0];
    const g = args[1];
    const b = args[2];
    if (r === g && g === b) {
  ...
  convert$1$2.ansi16.rgb = function(args) {
    let color2 = args % 10;
  ...
  convert$1$2.ansi256.rgb = function(args) {
    if (args >= 232) {
  ...
  convert$1$2.rgb.hex = function(args) {
    const integer = ((Math.round(args[0]) & 255) << 16) + ((Math.round(args[1]) & 255) << 8) + (Math.round(args[2]) & 255);
    const string = integer.toString(16).toUpperCase();
    return "000000".substring(string.length) + string;
  };
  convert$1$2.hex.rgb = function(args) {
  ...
  convert$1$2.rgb.hcg = function(rgb) {
    const r = rgb[0] / 255;
    const g = rgb[1] / 255;
    const b = rgb[2] / 255;
  ...
  convert$1$2.hsl.hcg = function(hsl) {
    const s = hsl[1] / 100;
    const l = hsl[2] / 100;
  ...
  convert$1$2.hsv.hcg = function(hsv) {
    const s = hsv[1] / 100;
    const v = hsv[2] / 100;
    const c = s * v;
    let f = 0;
  ...
  convert$1$2.hcg.rgb = function(hcg) {
    const h2 = hcg[0] / 360;
    const c = hcg[1] / 100;
    const g = hcg[2] / 100;
    if (c === 0) {
  ...
  convert$1$2.hcg.hsv = function(hcg) {
    const c = hcg[1] / 100;
    const g = hcg[2] / 100;
    const v = c + g * (1 - c);
    let f = 0;
  ...
  convert$1$2.hcg.hsl = function(hcg) {
    const c = hcg[1] / 100;
    const g = hcg[2] / 100;
    const l = g * (1 - c) + 0.5 * c;
    let s = 0;
  ...
  convert$1$2.hcg.hwb = function(hcg) {
    const c = hcg[1] / 100;
    const g = hcg[2] / 100;
    const v = c + g * (1 - c);
    return [hcg[0], (v - c) * 100, (1 - v) * 100];
  };
  convert$1$2.hwb.hcg = function(hwb) {
    const w = hwb[1] / 100;
    const b = hwb[2] / 100;
    const v = 1 - b;
    const c = v - w;
  ...
  convert$1$2.apple.rgb = function(apple) {
    return [apple[0] / 65535 * 255, apple[1] / 65535 * 255, apple[2] / 65535 * 255];
  };
  convert$1$2.rgb.apple = function(rgb) {
    return [rgb[0] / 255 * 65535, rgb[1] / 255 * 65535, rgb[2] / 255 * 65535];
  };
  convert$1$2.gray.rgb = function(args) {
    return [args[0] / 100 * 255, args[0] / 100 * 255, args[0] / 100 * 255];
  };
  convert$1$2.gray.hsl = function(args) {
    return [0, 0, args[0]];
  };
  convert$1$2.gray.hsv = convert$1$2.gray.hsl;
  convert$1$2.gray.hwb = function(gray) {
    return [0, 100, gray[0]];
  };
  convert$1$2.gray.cmyk = function(gray) {
    return [0, 0, 0, gray[0]];
  };
  convert$1$2.gray.lab = function(gray) {
    return [gray[0], 0, 0];
  };
  convert$1$2.gray.hex = function(gray) {
    const val = Math.round(gray[0] / 100 * 255) & 255;
    const integer = (val << 16) + (val << 8) + val;
    const string = integer.toString(16).toUpperCase();
    return "000000".substring(string.length) + string;
  };
  convert$1$2.rgb.gray = function(rgb) {
    const val = (rgb[0] + rgb[1] + rgb[2]) / 3;
    return [val / 255 * 100];
  };
  function buildGraph$2() {
    const graph = {};
    const models2 = Object.keys(conversions$2);
  ...
  var hashedModelKeys$2 = {};
  for (const model of Object.keys(colorConvert$2)) {
    hashedModelKeys$2[[...colorConvert$2[model].labels].sort().join("")] = model;
  }
  var limiters$2 = {};
  function Color$3(object, model) {
    if (!(this instanceof Color$3)) {
      return new Color$3(object, model);
    }
    if (model && model in skippedModels$2) {
      model = null;
    }
    ...
    if (object == null) {
      ...
      this.color = [0, 0, 0];
      this.valpha = 1;
    } else if (object instanceof Color$3) {
      ...
      this.color = zeroArray$2(newArray, channels);
      ...
      if (!(hashedKeys in hashedModelKeys$2)) {
        throw new Error("Unable to parse color from object: " + JSON.stringify(object));
      }
      this.model = hashedModelKeys$2[hashedKeys];
      const { labels } = colorConvert$2[this.model];
      const color2 = [];
      for (i = 0; i < labels.length; i++) {
        color2.push(object[labels[i]]);
      }
      this.color = zeroArray$2(color2);
    }
    if (limiters$2[this.model]) {
      channels = colorConvert$2[this.model].channels;
      for (i = 0; i < channels; i++) {
        const limit = limiters$2[this.model][i];
        if (limit) {
  ...
  Color$3.prototype = {
    ...
    string(places) {
      let self2 = this.model in colorString$2.to ? this : this.rgb();
      self2 = self2.round(typeof places === "number" ? places : 1);
      const args = self2.valpha === 1 ? self2.color : [...self2.color, this.valpha];
      return colorString$2.to[self2.model](args);
    },
    ...
    object() {
      const result = {};
      const { channels } = colorConvert$2[this.model];
      const { labels } = colorConvert$2[this.model];
    ...
    round(places) {
      ...
      return new Color$3([...this.color.map(roundToPlace$2(places)), this.valpha], this.model);
    },
    alpha(value) {
      if (value !== void 0) {
        return new Color$3([...this.color, Math.max(0, Math.min(1, value))], this.model);
      }
      return this.valpha;
    },
    red: getset$2("rgb", 0, maxfn$2(255)),
    green: getset$2("rgb", 1, maxfn$2(255)),
    blue: getset$2("rgb", 2, maxfn$2(255)),
    hue: getset$2(["hsl", "hsv", "hsl", "hwb", "hcg"], 0, (value) => (value % 360 + 360) % 360),
    saturationl: getset$2("hsl", 1, maxfn$2(100)),
    lightness: getset$2("hsl", 2, maxfn$2(100)),
    saturationv: getset$2("hsv", 1, maxfn$2(100)),
    value: getset$2("hsv", 2, maxfn$2(100)),
    chroma: getset$2("hcg", 1, maxfn$2(100)),
    gray: getset$2("hcg", 2, maxfn$2(100)),
    white: getset$2("hwb", 1, maxfn$2(100)),
    wblack: getset$2("hwb", 2, maxfn$2(100)),
    cyan: getset$2("cmyk", 0, maxfn$2(100)),
    magenta: getset$2("cmyk", 1, maxfn$2(100)),
    yellow: getset$2("cmyk", 2, maxfn$2(100)),
    black: getset$2("cmyk", 3, maxfn$2(100)),
    x: getset$2("xyz", 0, maxfn$2(95.047)),
    y: getset$2("xyz", 1, maxfn$2(100)),
    z: getset$2("xyz", 2, maxfn$2(108.833)),
    l: getset$2("lab", 0, maxfn$2(100)),
    a: getset$2("lab", 1),
    b: getset$2("lab", 2),
    keyword(value) {
      if (value !== void 0) {
        return new Color$3(value);
      }
    ...
    grayscale() {
      ...
      return Color$3.rgb(value, value, value);
    },
    fade(ratio) {
  ...
  for (const model of Object.keys(colorConvert$2)) {
    if (skippedModels$2.includes(model)) {
      continue;
    }
    const { channels } = colorConvert$2[model];
    Color$3.prototype[model] = function(...args) {
      if (this.model === model) {
        return new Color$3(this);
      }
      if (args.length > 0) {
        return new Color$3(args, model);
      }
      return new Color$3([...assertArray$2(colorConvert$2[this.model][model].raw(this.color)), this.valpha], model);
    };
    Color$3[model] = function(...args) {
      let color2 = args[0];
      if (typeof color2 === "number") {
        color2 = zeroArray$2(args, channels);
      }
      return new Color$3(color2, model);
    };
  }
  function roundTo$2(number, places) {
    return Number(number.toFixed(places));
  }
  function roundToPlace$2(places) {
    return function(number) {
      return roundTo$2(number, places);
    };
  }
  function getset$2(model, channel, modifier) {
    model = Array.isArray(model) ? model : [model];
    for (const m of model) {
      (limiters$2[m] || (limiters$2[m] = []))[channel] = modifier;
    }
    model = model[0];
  ...
  function maxfn$2(max) {
    return function(v) {
      return Math.max(0, Math.min(max, v));
    };
  }
  function assertArray$2(value) {
    return Array.isArray(value) ? value : [value];
  }
  function zeroArray$2(array, length) {
  ...
  var color$2 = Color$3;
  var Color$1$2 = color$2;
  var getRgbStr$2 = (color2) => {
    return Color$1$2(color2).rgb().round().array().join(",");
  };
  var formats$2 = ["hex", "rgb", "hsl"];
  function getFormat$2(format) {
    if (!format || formats$2.indexOf(format) < 0) {
      return "hex";
    }
    return format;
  }
  var getColorString$2 = (color2, format) => {
    const innerFormat = getFormat$2(format);
    if (innerFormat === "hex") {
      return color2[innerFormat]();
    }
    return color2[innerFormat]().round().string();
  };
  var colorPalette$2 = (originColor, i, format) => {
    const color2 = Color$1$2(originColor);
    const h2 = color2.hue();
    ...
    const retColor = i === 6 ? color2 : Color$1$2({
      h: getNewHue(isLight, index2),
      s: getNewSaturation(isLight, index2),
      v: getNewValue(isLight, index2)
    });
    return getColorString$2(retColor, format);
  };
  var colorPaletteDark$2 = (originColor, i, format) => {
    const lightColor = Color$1$2(colorPalette$2(originColor, 10 - i + 1, null));
    const originBaseColor = Color$1$2(originColor);
    const originBaseHue = originBaseColor.hue();
    const originBaseSaturation = originBaseColor.saturationv();
    const baseColor = Color$1$2({
  ...
  var generate2 = (color2, options = {
    ...
    if (list) {
      const list2 = [];
      for (let i = 1; i <= 10; i++) {
        const func = dark ? colorPaletteDark$2 : colorPalette$2;
        list2.push(func(color2, i, format));
      }
      return list2;
    }
    return dark ? colorPaletteDark$2(color2, index2, format) : colorPalette$2(color2, index2, format);
  };
  var colorList$2 = {
    red: "#F53F3F",
    orangered: "#F77234",
  ...
  var getPresetColors$2 = () => {
    const presetColors = [];
    Object.keys(colorList$2).forEach((key) => {
      presetColors[key] = [];
      presetColors[key]["light"] = generate2(colorList$2[key], {
        list: true,
        dark: false,
        index: 0
      });
      presetColors[key]["dark"] = generate2(colorList$2[key], {
        list: true,
        dark: true,
        index: 0
      });
      presetColors[key]["primary"] = colorList$2[key];
    });
    presetColors["gray"] = [];
  ...
  var colorBuilder$2 = {
    getPresetColors: getPresetColors$2,
    generate: generate2,
    getRgbStr: getRgbStr$2,
    getColorString: getColorString$2
  };
  var size_exports$1 = {};
  __export2(size_exports$1, {
    fontUnit: () => fontUnit$1,
    fontWeight: () => fontWeight$1,
    fonts: () => fonts$1,
    lineBase: () => lineBase$1,
    motionTimes: () => motionTimes$1,
    radiusSize: () => radiusSize$1,
    shadeOpenness: () => shadeOpenness$1,
    spacing: () => spacing$1
  });
  var fontUnit$1 = "px";
  var fonts$1 = {
  ...
  var config3 = {
    shade: `hsla(220, 17.1%, 13.7%, ${shadeOpenness$1})`,
    colorPresetPanel: {
      red: null,
      orangered: null,
      orange: null,
  ...
  var getPresetColor$1 = (key) => {
    return colorBuilder$2.getPresetColors()[key]["primary"];
  };
  var colorPresetPanel$1 = {
    red: getPresetColor$1("red"),
    orangered: getPresetColor$1("orangered"),
    orange: getPresetColor$1("orange"),
    gold: getPresetColor$1("gold"),
    yellow: getPresetColor$1("yellow"),
    lime: getPresetColor$1("lime"),
    green: getPresetColor$1("green"),
    brandgreen: getPresetColor$1("green"),
    cyan: getPresetColor$1("cyan"),
    blue: getPresetColor$1("blue"),
    deepblue: getPresetColor$1("arcoblue"),
    purple: getPresetColor$1("purple"),
    pinkpurple: getPresetColor$1("pinkpurple"),
    magenta: getPresetColor$1("magenta"),
    grey: getPresetColor$1("gray"),
    primary: getPresetColor$1("green"),
    success: getPresetColor$1("green"),
    danger: getPresetColor$1("red"),
    warning: getPresetColor$1("orange"),
    link: getPresetColor$1("blue"),
    info: getPresetColor$1("blue")
  };
  var colorPresetData$1 = {
    "red": colorPresetPanel$1.red,
    "orangered": colorPresetPanel$1.orangered,
    "orange": colorPresetPanel$1.orange,
    "gold": colorPresetPanel$1.gold,
    "yellow": colorPresetPanel$1.yellow,
    "lime": colorPresetPanel$1.lime,
    "green": colorPresetPanel$1.green,
    "brandgreen": colorPresetPanel$1.brandgreen,
    "cyan": colorPresetPanel$1.cyan,
    "blue": colorPresetPanel$1.blue,
    "deepblue": colorPresetPanel$1.deepblue,
    "purple": colorPresetPanel$1.purple,
    "pinkpurple": colorPresetPanel$1.pinkpurple,
    "magenta": colorPresetPanel$1.magenta,
    "grey": colorPresetPanel$1.grey,
    "primary": colorPresetPanel$1.primary,
    "success": colorPresetPanel$1.success,
    "danger": colorPresetPanel$1.danger,
    "warning": colorPresetPanel$1.warning,
    "link": colorPresetPanel$1.link,
    "info": colorPresetPanel$1.info
  };
  var colorPalette2$1 = (color2, index2, dark = false) => {
    return colorBuilder$2.generate(color2, { dark, list: false, index: index2 });
  };
  var makeColorByPalette$1 = (color2, dark) => {
    const colorData = [];
    for (let i = 1; i <= 10; i++) {
      colorData.push(colorPalette2$1(colorPresetData$1[color2], i, dark));
    }
    if (color2 === "grey" && dark) {
      return [
        "#17171a",
  ...
  var makeModeColors$1 = (dark) => {
    const modeColors = [];
    const colorPresetKey = Object.keys(colorPresetData$1);
    colorPresetKey.map((item) => {
      if (!dark) {
        modeColors[item] = [];
        modeColors[item] = makeColorByPalette$1(item, dark);
      } else {
        modeColors[item] = makeColorByPalette$1(item, !!dark);
      }
    });
  ...
  var darken$1 = (colorString2, alpha = 0.2) => {
    return "";
  };
  var colors = {
    light: makeModeColors$1(false),
    dark: makeModeColors$1(true),
    darken: darken$1
  };
  var colors2 = {
    light: colors.light,
  ...
  var { create: create$2 } = createComponent("page");
  ...
  var KuiPage = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3], ["styles", [_style_0$2]], ["__file", "E:/work/kviewui/src/packages/components/src/page/index.vue"]]);
  var globalProps = {
    mode: {
      type: String,
      default: () => {
  ...
  var cellGroupProps = __spreadProps(__spreadValues({}, globalProps), {
    title: {
      type: String,
      default: ""
    },
  ...
  var isArrayish$1 = function isArrayish22(obj) {
    if (!obj || typeof obj === "string") {
      return false;
    }
    return obj instanceof Array || Array.isArray(obj) || obj.length >= 0 && (obj.splice instanceof Function || Object.getOwnPropertyDescriptor(obj, obj.length - 1) && obj.constructor.name !== "String");
  ...
  var colorPalette2 = (color2, index2, dark = false) => {
    return colorBuilder$1.generate(color2, { dark, list: false, index: index2 });
  };
  ...
  var getCustomClass = (customClass) => {
  ...
  var { create: create$1 } = createComponent("cell-group");
  var _sfc_main$2 = create$1({
    ...
    setup(props, context) {
      ...
      const childrens = (0, import_vue.reactive)([]);
      const init = () => {
      ...
      (0, import_vue.provide)("cell-group", {
        childrens
      });
      return {
        theme: theme2,
  ...
  function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
      class: (0, import_vue.normalizeClass)(["kui-flex kui-flex-col", _ctx.getCustomClass(_ctx.customClass)]),
      renderWhole: true
    }, [
      (0, import_vue.createElementVNode)("view", { class: "kui-flex kui-flex-col kui-w-full" }, [
        (0, import_vue.createElementVNode)("view", { class: "" }, [
          (0, import_vue.renderSlot)(_ctx.$slots, "title", {}, () => [
            ...
            }, (0, import_vue.toDisplayString)(_ctx.title), 5)
          ])
        ]),
        (0, import_vue.createElementVNode)("view", {
          class: "kui-mt-1",
          ...
          (0, import_vue.renderSlot)(_ctx.$slots, "desc", {}, () => [
            (0, import_vue.createElementVNode)("u-text", null, (0, import_vue.toDisplayString)(_ctx.desc), 1)
          ])
        ], 4)
      ]),
      (0, import_vue.createElementVNode)("view", { class: "kui-mt-1" }, [
        (0, import_vue.renderSlot)(_ctx.$slots, "default")
      ])
    ], 2);
  }
  var KuiCellGroup = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2], ["__file", "E:/work/kviewui/src/packages/components/src/cell-group/index.vue"]]);
  var iconProps = __spreadProps(__spreadValues({}, globalProps), {
    name: {
      type: String,
      default: ""
    },
  ...
  var id = "3857824";
  var name = "kui-icons";
  var font_family = "kui-icons";
  var css_prefix_text = "kui-icon-";
  var description = "kviewui\u7EC4\u4EF6\u56FE\u6807\u5E93";
  var glyphs = [
    {
      icon_id: "1493652",
  ...
  var iconUrl = "/assets/kuiIcons.8bff03cf.ttf";
  var { create } = createComponent("icon");
  var _sfc_main$1 = create({
    ...
    setup(props) {
      ...
      const unicode = (0, import_vue.computed)(() => {
        if (props.unicode) {
      ...
      (0, import_vue.onBeforeMount)(() => {
        const domModule2 = requireNativePlugin("dom");
  ...
  var _style_0$1 = { "kui-icons": { "": { "fontFamily": "kui-icons", "textDecoration": "none" } } };
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("u-text", {
      class: (0, import_vue.normalizeClass)(["kui-icons", [_ctx.customClassName, _ctx.customClass]]),
      style: (0, import_vue.normalizeStyle)(_ctx.iconStyle)
    }, "\uE61A", 6);
  }
  var KuiIcons = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["styles", [_style_0$1]], ["__file", "E:/work/kviewui/src/packages/components/src/icons/index.vue"]]);
  var spaceProps = {
    justify: {
      type: String,
      default: "flex-start"
  ...
  var _sfc_main = (0, import_vue.defineComponent)({
    ...
    setup(props, context) {
      let childrens = (0, import_vue.reactive)([]);
      const data = (0, import_vue.reactive)({
      ...
      init();
      (0, import_vue.provide)("spaceComponent", (0, import_vue.computed)(() => childrens));
      return {
        data,
        pushChildrens,
        childrens,
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
      renderWhole: true,
      class: (0, import_vue.normalizeClass)(["kui-flex kui-flex-wrap", [_ctx.data.direction === "column" && _ctx.block ? "kui-w-full1" : ""]]),
      style: (0, import_vue.normalizeStyle)({
  ...
  var KuiSpace = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "E:/work/kviewui/src/packages/components/src/space/index.vue"]]);
  ...
  var { create: create$22 } = createComponent("image");
  var intersectionObserver;
  var _sfc_main$4 = create$22({
    props: imageProps,
    ...
    setup(props, context) {
      const data = (0, import_vue2.reactive)({
        ...
        iconSize: 100,
        slotLoading: (0, import_vue2.useSlots)().loading,
        slotError: (0, import_vue2.useSlots)().error,
        src: props.src,
        lazyloaded: false
      });
      const elId = getElId();
  ...
  function _sfc_render$32(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
      class: (0, import_vue2.normalizeClass)(["kui-leading-none", _ctx.elId]),
      renderWhole: true
    }, [
      ...
      _ctx.data.loading || _ctx.error ? ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
        key: 0,
        class: (0, import_vue2.normalizeClass)(["kui-bg-gray-200 kui-flex kui-flex-col kui-justify-center kui-items-center", _ctx.data.animateShow ? "kui-animate-pulse" : ""]),
        ...
        (0, import_vue2.createCommentVNode)(' <kui-icons type="image" :size="Number(data.iconSize)" class="kui-text-gray-300"></kui-icons> ')
      ], 6)) : (0, import_vue2.createCommentVNode)("v-if", true),
      !_ctx.data.loading && _ctx.data.src && _ctx.disableFit && !_ctx.error ? ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("u-image", {
        key: 1,
        src: _ctx.data.src,
        style: (0, import_vue2.normalizeStyle)({
          width: _ctx.width,
      ...
      !_ctx.data.loading && _ctx.data.src && !_ctx.disableFit ? ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("u-image", {
        key: 2,
        src: _ctx.data.src,
        mode: _ctx.fit,
        style: (0, import_vue2.normalizeStyle)({
      ...
      }, null, 12, ["src", "mode"])) : (0, import_vue2.createCommentVNode)("v-if", true)
    ], 2);
  }
  var KuiImage = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$32], ["__file", "E:/work/kviewui/src/packages/components/src/image/index.vue"]]);
  var containerProps = {
    backgroundColor: {
      type: String,
      default: ""
    ...
    mode: {
      ...
      default: () => {
        var _a3, _b2;
        return (_b2 = (_a3 = (0, import_vue2.inject)(configProviderInjectionKey, void 0)) == null ? void 0 : _a3.mode) != null ? _b2 : "light";
      }
    },
    customClass: {
      type: String,
  ...
  var { create: create$12 } = createComponent("container");
  var _sfc_main$32 = create$12({
  ...
  function _sfc_render$22(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
      class: (0, import_vue2.normalizeClass)([[_ctx.customClass], "kui-container kui-flex kui-flex-col kui-box-border kui-flex-shrink"]),
      style: (0, import_vue2.normalizeStyle)(__spreadValues({
        width: _ctx.width,
        height: _ctx.height,
  ...
  var KuiContainer = /* @__PURE__ */ _export_sfc(_sfc_main$32, [["render", _sfc_render$22], ["styles", [_style_0$3]], ["__file", "E:/work/kviewui/src/packages/components/src/container/index.vue"]]);
  var cellProps = {
    title: {
      type: String,
      default: ""
  ...
  var iconUrl2 = "/assets/uniicons.89ed7d6d.ttf";
  var _style_0$22 = { "uni-icons": { "": { "fontFamily": "uniicons", "textDecoration": "none", "textAlign": "center" } } };
  var getVal = (val) => {
    const reg = /^[0-9]*$/g;
  ...
  var UniIcons = /* @__PURE__ */ _export_sfc(_sfc_main$22, [["render", _sfc_render$12], ["styles", [_style_0$22]], ["__file", "E:/work/kviewui/src/packages/components/uni_modules/uni-icons/components/uni-icons/uni-icons.vue"]]);
  var { create: create2 } = createComponent("cell");
  var _sfc_main$12 = create2({
    props: cellProps,
    components: {
      KuiIcons,
      UniIcons
    ...
    setup(props, context) {
      ...
      const getCellGroup = () => {
        return (0, import_vue2.inject)("cell-group");
      };
      ...
      const changeMode = (steep = 0) => {
        ...
        data.descColor = data.mode === "light" ? props.descColor ? props.descColor : colorGreys[4] : props.descColor ? `hsl(${theme2.colors.darken(props.descColor).color[0]},${theme2.colors.darken(props.descColor).color[1]}%,${theme2.colors.darken(props.descColor).color[2]}%)` : colorGreys(true)[4];
      };
      (0, import_vue2.onMounted)(() => {
  ...
  function _sfc_render2(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_kui_icons = (0, import_vue2.resolveComponent)("kui-icons");
    return (0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
      ...
      (0, import_vue2.createElementVNode)("view", {
        class: (0, import_vue2.normalizeClass)(["kui-flex kui-justify-between kui-w-full1", _ctx.center ? "kui-items-center" : ""])
      }, [
        (0, import_vue2.createElementVNode)("view", { class: "kui-flex kui-items-center kui-w-full1" }, [
          (0, import_vue2.renderSlot)(_ctx.$slots, "left-icon", {}, () => [
            _ctx.icon ? ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
              key: 0,
              class: "kui-mr-1"
            }, [
              (0, import_vue2.createCommentVNode)(' <kui-icons :type="icon" :size="50" color="#999"></kui-icons> ')
            ])) : (0, import_vue2.createCommentVNode)("v-if", true)
          ]),
          (0, import_vue2.renderSlot)(_ctx.$slots, "content", {}, () => [
            (0, import_vue2.createElementVNode)("view", { class: "kui-flex" }, [
              ...
              }, (0, import_vue2.toDisplayString)(_ctx.title), 5),
              _ctx.subTitle ? ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("u-text", {
                key: 0,
                class: "kui-mt-1",
                style: (0, import_vue2.normalizeStyle)({
                  fontSize: `${_ctx.theme.size.fonts["base"]}${_ctx.theme.size.fontUnit}`,
              ...
              }, (0, import_vue2.toDisplayString)(_ctx.subTitle), 5)) : (0, import_vue2.createCommentVNode)("v-if", true)
            ])
          ])
        ]),
        (0, import_vue2.createElementVNode)("view", {
          class: (0, import_vue2.normalizeClass)(["kui-h-auto kui-leading-none kui-flex kui-flex kui-justify-end", _ctx.center ? "kui-items-center" : ""])
        }, [
          (0, import_vue2.createElementVNode)("u-text", {
            class: "kui-mr-1",
            style: (0, import_vue2.normalizeStyle)({
          ...
          }, (0, import_vue2.toDisplayString)(_ctx.desc), 5),
          _ctx.showRightIcon ? ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
            key: 0,
            class: "kui-flex kui-flex-col kui-justify-center"
          }, [
            (0, import_vue2.renderSlot)(_ctx.$slots, "right-icon", {}, () => [
              (0, import_vue2.createVNode)(_component_kui_icons, {
                name: "right",
                size: 16,
                color: "#999",
                weight: 100
      ...
      (0, import_vue2.createElementVNode)("view", { class: "kui-pt-2" }, [
        _ctx.data.isBorder ? ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
          key: 0,
  ...
  var KuiCell = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["render", _sfc_render2], ["styles", [_style_0$12]], ["__file", "E:/work/kviewui/src/packages/components/src/cell/index.vue"]]);
  var _sfc_main2 = /* @__PURE__ */ (0, import_vue2.defineComponent)({
    __name: "index",
    setup(__props) {
      (0, import_vue2.ref)("Hello");
      uni.$kView.theme;
      const pageRef = (0, import_vue2.ref)(null);
      (0, import_vue2.ref)(false);
      let sysinfo = (0, import_vue2.reactive)({});
      const systemInfo = (0, import_vue2.reactive)({ windowHeight: "" });
      let style = (0, import_vue2.reactive)({});
      const contentHeight = (0, import_vue2.ref)("");
      (0, import_vue2.watch)(
      ...
      return (_ctx, _cache) => {
        return (0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("scroll-view", {
          ...
          (0, import_vue2.createVNode)(KuiPage, {
            ref_key: "pageRef",
            ref: pageRef,
            "padding-x": 0,
            "padding-y": 0,
            ...
            body: (0, import_vue2.withCtx)(() => [
              (0, import_vue2.createElementVNode)("view", { class: "kui-flex-col kui-items-center kui-pt-6" }, [
                (0, import_vue2.createVNode)(KuiImage, {
                ...
                (0, import_vue2.createElementVNode)("view", { class: "kui-px-6 kui-mt-5" }, [
                  (0, import_vue2.createCommentVNode)(' <kui-text size="16px" :color="theme.colors.light.grey[6]"\r\n                        content="\u57FA\u4E8EUNI-APP\u6846\u67B6\u7684\u591A\u7AEF\u5F00\u53D1UI\u7EC4\u4EF6\u5E93\uFF0C\u8BA9\u60A8\u7684\u5F00\u53D1\u6548\u7387\u52A0\u500D\u63D0\u5347" /> ')
                ]),
                (0, import_vue2.createVNode)(KuiContainer, {
                  width: "750rpx",
                  ...
                  default: (0, import_vue2.withCtx)(() => [
                    (0, import_vue2.createElementVNode)("view", { class: "kui-mt-6 kui-items-start kui-flex" }, [
                      (0, import_vue2.createCommentVNode)(' <kui-text size="16px" content="\u6697\u9ED1\u6A21\u5F0F\uFF1A" /> '),
                      (0, import_vue2.createCommentVNode)(' <kui-switch v-model="checked" /> ')
                    ]),
                    (0, import_vue2.createElementVNode)("view", { class: "kui-mt-3" }, [
                      (0, import_vue2.createVNode)(KuiCellGroup, {
                        title: "\u57FA\u7840\u7EC4\u4EF6",
                        type: "space",
                        ...
                        default: (0, import_vue2.withCtx)(() => [
                          (0, import_vue2.createVNode)(KuiCell, {
                            title: "Button \u6309\u94AE",
                ...
                (0, import_vue2.createVNode)(KuiSpace)
              ])
            ]),
            _: 1
          }, 512)
  ...
  var _style_02 = { "content": { "": { "display": "flex", "flexDirection": "column", "alignItems": "center", "justifyContent": "center" } }, "logo": { "": { "height": "200rpx", "width": "200rpx", "marginTop": "200rpx", "marginBottom": "50rpx" } }, "text-area": { "": { "display": "flex", "justifyContent": "center" } }, "title": { "": { "fontSize": "36rpx" } }, "kui-iconfont": { "": { "fontFamily": "kview-icons", "fontSize": 120, "color": "#0000FF" } } };
  var index = /* @__PURE__ */ _export_sfc(_sfc_main2, [["styles", [_style_02]], ["__file", "E:/work/kviewui/src/examples/mobile-uni-cli/src/pages/index/index.nvue"]]);
