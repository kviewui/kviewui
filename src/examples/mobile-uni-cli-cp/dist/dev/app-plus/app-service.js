...
(function(vue) {
  ...
  const createHook$1 = (lifecycle) => (hook, target = vue.getCurrentInstance()) => {
...
${codeFrame}` : message);
  ...
  var createComponent = (name2) => {
    ...
    return {
      ...
      create: function(componentOptions) {
        ...
        componentOptions.install = (vue2) => {
          vue2.component(componentOptions.name, componentOptions);
        };
  ...
  var generate2 = (color2, options = {
    ...
    return dark ? colorPaletteDark$2(color2, index, format) : colorPalette$2(color2, index, format);
  };
  var colorList$2 = {
    red: "#F53F3F",
    orangered: "#F77234",
  ...
  var colorPalette2$1 = (color2, index, dark = false) => {
    return colorBuilder$2.generate(color2, { dark, list: false, index });
  };
  ...
  var getFontSize$1 = (size2) => {
    if (isNumber(size2) || getUnitByUnit(size2) === "")
      return `${size2}${theme$1.size.fontUnit}`;
    return size2;
  };
  ...
  const globalProps = {
    mode: {
      ...
      default: () => {
        var _a3, _b2;
        return (_b2 = (_a3 = vue.inject(configProviderInjectionKey, void 0)) == null ? void 0 : _a3.mode) != null ? _b2 : "light";
      }
    },
    customClass: {
      type: String,
  ...
  const id$1 = "3857824";
  const name$1 = "kui-icons";
  const font_family$1 = "kui-icons";
  const css_prefix_text$1 = "kui-icon-";
  const description$1 = "kviewui\u7EC4\u4EF6\u56FE\u6807\u5E93";
  const glyphs$1 = [
    {
      icon_id: "1493652",
  ...
  const iconCode = {
    ...
    css_prefix_text: css_prefix_text$1,
  ...
  const { create: create$a } = createComponent("icon");
  const _sfc_main$e = create$a({
    props: iconProps$1,
    setup(props) {
      const iconStyle = vue.computed(() => {
        const style = vue.reactive({});
        style.color = colorBuilder$1.generate(props.color, { dark: props.mode === "dark", list: true })[props.colorLevel];
        style.fontSize = getFontSize$1(props.size);
  ...
  function _sfc_render$d(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("text", {
      class: vue.normalizeClass(["kui-icons", [_ctx.customClassName, `${_ctx.customPrefix}${_ctx.name}`, _ctx.customClass]]),
      style: vue.normalizeStyle(_ctx.iconStyle)
    }, null, 6);
  }
  const Icons = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$d], ["__scopeId", "data-v-edf640fb"], ["__file", "E:/work/kviewui/src/packages/components/src/icons/index.vue"]]);
  const buttonProps = {
    type: {
      type: String,
      default: ""
  ...
  const _sfc_main$d = vue.defineComponent({
    ...
    setup(props, context) {
      ...
      vue.getCurrentInstance().proxy.$parent.$parent;
      vue.onMounted(() => {
      });
  ...
  function _sfc_render$c(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_kui_icons = vue.resolveComponent("kui-icons");
    return vue.openBlock(), vue.createElementBlock("view", {
      ...
      vue.createElementVNode("button", {
        "render-whole": true,
        class: vue.normalizeClass(["kui-flex kui-leading-none kui-items-center", [_ctx.data.shadowClass]]),
        elevation: _ctx.data.elevationSize,
        plain: true,
        disabled: _ctx.disabled,
        style: vue.normalizeStyle({
          borderWidth: _ctx.data.btnBorderWidth,
          borderColor: _ctx.data.btnBorderColor,
          borderStyle: _ctx.data.btnBorderStyle,
          width: _ctx.data.width,
          height: _ctx.data.height,
          borderRadius: `${_ctx.data.radius}${_ctx.theme.size.fontUnit}`,
          backgroundColor: _ctx.data.backgroundColor,
          backgroundImage: _ctx.data.backgroundImage,
          marginLeft: _ctx.data.marginLeft,
          marginBottom: _ctx.data.marginBottom,
          marginRight: _ctx.data.marginRight,
          marginTop: _ctx.data.marginTop,
          padding: _ctx.data.padding,
          opacity: _ctx.data.btnOpacity,
          flex: _ctx.data.btnFlex,
          flexGrow: _ctx.data.btnFlexGrow,
        ...
        onTouchstart: _cache[0] || (_cache[0] = (...args) => _ctx.start && _ctx.start(...args)),
        onTouchend: _cache[1] || (_cache[1] = (...args) => _ctx.end && _ctx.end(...args)),
        onClick: _cache[2] || (_cache[2] = (...args) => _ctx.beforeStart && _ctx.beforeStart(...args)),
        onGetphonenumber: _cache[3] || (_cache[3] = (...args) => _ctx.onGetphonenumber && _ctx.onGetphonenumber(...args)),
        onGetuserinfo: _cache[4] || (_cache[4] = (...args) => _ctx.onGetuserinfo && _ctx.onGetuserinfo(...args)),
        onError: _cache[5] || (_cache[5] = (...args) => _ctx.onError && _ctx.onError(...args)),
        onOpensetting: _cache[6] || (_cache[6] = (...args) => _ctx.onOpensetting && _ctx.onOpensetting(...args)),
        onLaunchapp: _cache[7] || (_cache[7] = (...args) => _ctx.onLaunchapp && _ctx.onLaunchapp(...args))
      }, [
        vue.createElementVNode("view", {
          ...
          _ctx.loading ? (vue.openBlock(), vue.createElementBlock("view", {
            key: 0,
            class: vue.normalizeClass(["kui-relative", [_ctx.content ? "kui-mr-1" : ""]]),
            style: vue.normalizeStyle({
              right: `${_ctx.$slots.default ? 10 : 0}rpx`
            })
          }, [
            vue.createCommentVNode(' <kui-spin :width="55" :height="55" :type="loadingType" :scale="0.7" :background-color="data.color"></kui-spin> '),
            vue.createVNode(_component_kui_icons, {
          ...
          _ctx.icon ? (vue.openBlock(), vue.createElementBlock("view", {
            key: 1,
            class: vue.normalizeClass(_ctx.$slots.default ? "kui-mr-1" : "")
          }, [
            vue.createCommentVNode(' <kui-icons :type="icon" :color="data.color" :weight="800" :size="40"></kui-icons> ')
          ...
          vue.createElementVNode("view", { class: "" }, [
            vue.renderSlot(_ctx.$slots, "default", {}, () => [
              ...
              }, vue.toDisplayString(_ctx.content), 5)
            ], true),
            vue.renderSlot(_ctx.$slots, "content", {}, void 0, true)
          ])
        ], 4)
      ], 46, ["elevation", "disabled", "form-type", "open-type", "hover-class", "hover-start-time", "hover-stay-time", "app-parameter", "hover-stop-propagation", "lang", "session-from", "send-message-title", "send-message-path", "send-message-img", "show-message-card"])
    ], 8, ["id"]);
  }
  const Button = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$c], ["__scopeId", "data-v-68f92122"], ["__file", "E:/work/kviewui/src/packages/components/src/button/index.vue"]]);
  const pageProps = {
    bgColor: {
      type: String,
      default: ""
  ...
  const _sfc_main$c = create$9({
    ...
    setup(props) {
      ...
      let height;
      if (props.fullscreen) {
        height = vue.useSlots().body || props.useBodySlot ? sysinfo.screenHeight : 0;
      } else {
        height = "";
      }
  ...
  function _sfc_render$b(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", {
      ...
      _ctx.customHeader ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
        style: vue.normalizeStyle({
        ...
        vue.renderSlot(_ctx.$slots, "statusBar", {}, void 0, true)
      ...
      _ctx.customHeader ? (vue.openBlock(), vue.createElementBlock("view", {
        ...
        _ctx.title ? (vue.openBlock(), vue.createElementBlock("text", { key: 0 }, vue.toDisplayString(_ctx.title), 1)) : vue.renderSlot(_ctx.$slots, "headerBar", { key: 1 }, void 0, true)
      ], 4)) : vue.createCommentVNode("v-if", true),
      !_ctx.disableScroll ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 2,
        class: vue.normalizeClass(["kui-page", _ctx.bgClass]),
        style: vue.normalizeStyle({
        ...
        onMousewheel: _cache[1] || (_cache[1] = vue.withModifiers(() => {
        }, ["prevent"]))
      }, [
        vue.renderSlot(_ctx.$slots, "body", {}, void 0, true)
      ], 38)),
  ...
  const Page = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$b], ["__scopeId", "data-v-9a10cdcc"], ["__file", "E:/work/kviewui/src/packages/components/src/page/index.vue"]]);
  const imageProps = {
    src: {
      type: String,
      default: ""
  ...
  const _sfc_main$b = create$8({
    ...
    setup(props, context) {
      const data = vue.reactive({
        ...
        iconSize: 100,
        slotLoading: vue.useSlots().loading,
  ...
  function _sfc_render$a(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", {
      class: vue.normalizeClass(["kui-leading-none", _ctx.elId])
    }, [
      ...
      _ctx.data.loading || _ctx.error ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
        class: vue.normalizeClass(["kui-bg-gray-200 kui-flex kui-flex-col kui-justify-center kui-items-center", _ctx.data.animateShow ? "kui-animate-pulse" : ""]),
        style: vue.normalizeStyle({
          width: _ctx.width,
          height: _ctx.height,
        ...
        vue.createCommentVNode(' <kui-icons type="image" :size="Number(data.iconSize)" class="kui-text-gray-300"></kui-icons> ')
      ], 6)) : vue.createCommentVNode("v-if", true),
      !_ctx.data.loading && _ctx.data.src && _ctx.disableFit && !_ctx.error ? (vue.openBlock(), vue.createElementBlock("image", {
        key: 1,
        src: _ctx.data.src,
        style: vue.normalizeStyle({
          width: _ctx.width,
      ...
      !_ctx.data.loading && _ctx.data.src && !_ctx.disableFit ? (vue.openBlock(), vue.createElementBlock("image", {
        key: 2,
        src: _ctx.data.src,
        mode: _ctx.fit,
        style: vue.normalizeStyle({
  ...
  const Image = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$a], ["__scopeId", "data-v-50ce88ea"], ["__file", "E:/work/kviewui/src/packages/components/src/image/index.vue"]]);
  const textProps = {
    mode: {
      type: String,
      default: () => {
    ...
    color: {
      ...
      default: () => {
        var _a3, _b2;
        return (_b2 = (_a3 = vue.inject(configProviderInjectionKey, void 0)) == null ? void 0 : _a3.color) != null ? _b2 : "";
      }
    },
    size: {
      type: String,
      default: () => {
        var _a3, _b2;
        return (_b2 = (_a3 = vue.inject(configProviderInjectionKey, void 0)) == null ? void 0 : _a3.fontSize) != null ? _b2 : "";
      }
    },
    weight: {
      type: Number,
  ...
  const _sfc_main$a = create$7({
    ...
    setup(props) {
      ...
      const changeMode = (e) => {
        ...
        const colorMap = theme2.colors[e][props.color] ? theme2.colors[e][props.color] : colorBuilder$1.generate(color2, { dark: isDark, list: true });
  ...
  function _sfc_render$9(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    }, vue.toDisplayString(_ctx.content), 13, ["selectable", "user-select", "space", "decode"]);
  }
  const Text = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$9], ["__file", "E:/work/kviewui/src/packages/components/src/text/index.vue"]]);
  ...
  function _sfc_render$8(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", {
      class: vue.normalizeClass([[_ctx.customClass], "kui-container kui-flex kui-flex-col kui-box-border kui-flex-shrink"]),
      style: vue.normalizeStyle({
        width: _ctx.width,
        height: _ctx.height,
  ...
  const Container = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__scopeId", "data-v-526f1d32"], ["__file", "E:/work/kviewui/src/packages/components/src/container/index.vue"]]);
  const switchProps = {
    modelValue: {
      type: Boolean,
      default: false
  ...
  const _sfc_main$8 = create$5({
    ...
    setup(props, { emit: emit2 }) {
      ...
      const buttonState = vue.reactive({
        status: isActive.value ? "open" : "close"
      });
      const iconState = vue.reactive({
        size: 20,
        color: ""
      });
      console.log(theme2.colors);
      const textState = vue.reactive({
  ...
  function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_kui_text = vue.resolveComponent("kui-text");
    return vue.openBlock(), vue.createElementBlock("view", {
      ...
      vue.createElementVNode("view", {
        class: vue.normalizeClass(["kui-switch-button kui-flex kui-justify-center kui-items-center", [_ctx.buttonState.status]]),
        style: vue.normalizeStyle(_ctx.buttonStyle)
      }, [
        vue.createCommentVNode(' <kui-animation name="rotate-center" :duration="1" runing infinite v-if="rootState.loading">\r\n				<kui-icons :size="iconState.size" :color="iconState.color" type="spinner6"></kui-icons>\r\n			</kui-animation> '),
        _ctx.activeText && _ctx.modelValue ? (vue.openBlock(), vue.createElementBlock("view", {
          key: 0,
          class: "open-text"
        }, [
          vue.createVNode(_component_kui_text, {
            content: _ctx.activeText,
            size: _ctx.textState.size,
            color: _ctx.textState.color
          }, null, 8, ["content", "size", "color"])
        ])) : vue.createCommentVNode("v-if", true),
        _ctx.inactiveText && !_ctx.modelValue ? (vue.openBlock(), vue.createElementBlock("view", {
          key: 1,
          class: "close-text"
        }, [
          vue.createVNode(_component_kui_text, {
  ...
  const Switch = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$7], ["__scopeId", "data-v-f2e8e81e"], ["__file", "E:/work/kviewui/src/packages/components/src/switch/index.vue"]]);
  ...
  var colorPalette2 = (color2, index, dark = false) => {
    return colorBuilder.generate(color2, { dark, list: false, index });
  };
  ...
  function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", {
      class: vue.normalizeClass(["kui-animation", _ctx.state.name]),
      style: vue.normalizeStyle({
  ...
  const Animation = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__scopeId", "data-v-c768d236"], ["__file", "E:/work/kviewui/src/packages/components/src/animation/index.vue"]]);
  ...
  const _sfc_main$6 = create$3({
    ...
    setup(props, context) {
      ...
      const data = vue.reactive({
        color: colorBuilder$1.generate("grey", {
  ...
  function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", {
      class: vue.normalizeClass(["kui-flex kui-flex-col", _ctx.getCustomClass(_ctx.customClass)])
    }, [
      vue.createElementVNode("view", { class: "kui-flex kui-flex-col kui-w-full" }, [
        vue.createElementVNode("view", { class: "" }, [
        ...
        vue.createElementVNode("view", {
          ...
          vue.renderSlot(_ctx.$slots, "desc", {}, () => [
            vue.createElementVNode("text", null, vue.toDisplayString(_ctx.desc), 1)
          ])
        ], 4)
      ]),
      vue.createElementVNode("view", { class: "kui-mt-1" }, [
        vue.renderSlot(_ctx.$slots, "default")
      ])
    ], 2);
  }
  const CellGroup = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__file", "E:/work/kviewui/src/packages/components/src/cell-group/index.vue"]]);
  const cellProps = {
    title: {
      type: String,
      default: ""
  ...
  const UniIcons = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__scopeId", "data-v-0cbd17cf"], ["__file", "E:/work/kviewui/src/packages/components/uni_modules/uni-icons/components/uni-icons/uni-icons.vue"]]);
  ...
  const _sfc_main$4 = create$2({
    ...
    setup(props, context) {
      const elId = `kUI_${Math.ceil(new Date().getTime() * 1e6).toString(36)}`;
      const theme2 = uni["$kView"].theme;
      const colorGreys = (dark = false) => colorBuilder$1.generate("grey", {
        dark,
        list: true
      });
      const data = vue.reactive({
      ...
      const getCellGroup = () => {
        return vue.inject("cell-group");
      };
      const cellGroup = getCellGroup();
      const changeMode = (steep = 0) => {
        data.color = data.mode === "light" ? props.color ? props.color : colorGreys[8] : props.color ? colorBuilder$1.generate(props.color, {
          dark: true,
          list: false,
          index: 6
        }) : colorGreys(true)[9];
        data.backgroundColor = data.mode === "light" ? "#FFFFFF" : colorGreys(true)[2];
        data.subTitleColor = data.mode === "light" ? props.color ? props.color : colorGreys[7] : props.color ? colorBuilder$1.generate(props.color, {
          dark: true,
          list: false,
          index: 7
        }) : colorGreys(true)[7];
  ...
  function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", {
      ...
      vue.createElementVNode("view", {
        class: vue.normalizeClass(["kui-flex kui-justify-between kui-w-full1", _ctx.center ? "kui-items-center" : ""])
      }, [
        vue.createElementVNode("view", { class: "kui-flex kui-items-center kui-w-full1" }, [
          vue.renderSlot(_ctx.$slots, "left-icon", {}, () => [
            _ctx.icon ? (vue.openBlock(), vue.createElementBlock("view", {
              key: 0,
              class: "kui-mr-1"
            }, [
              vue.createCommentVNode(' <kui-icons :type="icon" :size="50" color="#999"></kui-icons> ')
            ])) : vue.createCommentVNode("v-if", true)
          ], true),
          vue.renderSlot(_ctx.$slots, "content", {}, () => [
            vue.createElementVNode("view", { class: "kui-flex" }, [
              vue.createElementVNode("text", {
                class: "",
                style: vue.normalizeStyle({
              ...
              _ctx.subTitle ? (vue.openBlock(), vue.createElementBlock("text", {
                key: 0,
                class: "kui-mt-1",
                style: vue.normalizeStyle({
                  fontSize: `${_ctx.theme.size.fonts["base"]}${_ctx.theme.size.fontUnit}`,
              ...
              }, vue.toDisplayString(_ctx.subTitle), 5)) : vue.createCommentVNode("v-if", true)
            ])
          ], true)
        ]),
        vue.createElementVNode("view", {
          class: vue.normalizeClass(["kui-h-auto kui-leading-none kui-flex kui-flex kui-justify-end", _ctx.center ? "kui-items-center" : ""])
        }, [
          vue.createElementVNode("text", {
            class: "kui-mr-1",
            style: vue.normalizeStyle({
          ...
          }, vue.toDisplayString(_ctx.desc), 5),
          _ctx.showRightIcon ? (vue.openBlock(), vue.createElementBlock("view", {
            key: 0,
      ...
      vue.createElementVNode("view", { class: "kui-pt-2" }, [
        _ctx.data.isBorder ? (vue.openBlock(), vue.createElementBlock("view", {
          key: 0,
  ...
  const Cell = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__scopeId", "data-v-809520eb"], ["__file", "E:/work/kviewui/src/packages/components/src/cell/index.vue"]]);
  const iconProps = {
    ...globalProps,
    name: {
      type: String,
  ...
  function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("text", {
      style: vue.normalizeStyle(_ctx.iconStyle),
      class: vue.normalizeClass(["kui-icon", [`kui-${_ctx.name}`, _ctx.customClassName, `${_ctx.customPrefix}${_ctx.name}`]])
    }, null, 6);
  }
  const Icon = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__scopeId", "data-v-61b971ae"], ["__file", "E:/work/kviewui/src/packages/components/src/icon/index.vue"]]);
  const spaceProps = {
    justify: {
      type: String,
      default: "flex-start"
  ...
  const _sfc_main$2 = vue.defineComponent({
    ...
    setup(props, context) {
      ...
      init();
      vue.provide("spaceComponent", vue.computed(() => childrens));
      return {
        data,
        pushChildrens,
        childrens,
  ...
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", {
      "render-whole": true,
      class: vue.normalizeClass(["kui-flex kui-flex-wrap", [_ctx.data.direction === "column" && _ctx.block ? "kui-w-full1" : ""]]),
      style: vue.normalizeStyle({
  ...
  const Space = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__scopeId", "data-v-9ceb19a2"], ["__file", "E:/work/kviewui/src/packages/components/src/space/index.vue"]]);
  const { create } = createComponent("config-provider");
  const _sfc_main$1 = create({
    props: configProviderProps,
    emits: ["update:mode"],
    setup(props, { slots, emit: emit2 }) {
      let config2 = vue.reactive({
        mode: props.mode,
        color: props.color,
        fontSize: props.fontSize
      });
      vue.provide(configProviderInjectionKey, config2);
      uni.$on("changeMode", (e) => {
        config2.mode = e;
        vue.provide(configProviderInjectionKey, config2);
      });
  ...
  const ConfigProvider = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "E:/work/kviewui/src/packages/components/src/config-provider/index.vue"]]);
  function install(app2) {
    const packages = [Button, Page, Image, Text, Container, Switch, Animation, CellGroup, Cell, Icon, Icons, Space, ConfigProvider];
  ...
  const app = vue.createSSRApp(__vitePreload(() => import("vue"), false ? "__VITE_PRELOAD__" : void 0));
  uni["$kView"] = {
    install,
    theme,
    app
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "E:/work/kviewui/src/examples/mobile-uni-cli/src/App.vue"]]);
  formatAppLog("log", "at main.ts:3", KviewUI);
  function createApp() {
