var _a2, _b;
import { inject as inject$1, computed as computed$1, reactive as reactive$1, onBeforeMount as onBeforeMount$1, openBlock as openBlock$1, createElementBlock as createElementBlock$1, normalizeClass as normalizeClass$1, normalizeStyle as normalizeStyle$1, defineComponent as defineComponent$1, getCurrentInstance as getCurrentInstance$1, ref as ref$1, onMounted as onMounted$1, toRefs as toRefs$1, resolveComponent as resolveComponent$1, createVNode as createVNode$1, withCtx as withCtx$1, createElementVNode, createCommentVNode as createCommentVNode$1, renderSlot as renderSlot$1, toDisplayString as toDisplayString$1, provide as provide$1, useSlots as useSlots$1, withModifiers as withModifiers$1, nextTick as nextTick$1 } from "vue";
...
const { create: create$3 } = createComponent("icon");
...
const _style_0$2 = { "kui-icons": { "": { "fontFamily": "kui-icons", "textDecoration": "none" } } };
...
const KuiIcons = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["styles", [_style_0$2]], ["__file", "E:/work/kviewui/src/packages/components/src/icons/index.vue"]]);
const buttonProps = {
  type: {
    type: String,
    default: ""
...
const _sfc_main$5 = defineComponent$1({
  ...
  setup(props, context) {
    ...
    const getSpaceInstance = () => {
      return inject$1("spaceComponent");
    };
    let parentSpace;
    parentSpace = getCurrentInstance$1().proxy.$parent;
    onMounted$1(() => {
      if (getSpaceInstance()) {
...
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_button = resolveComponent$1("button");
  return openBlock$1(), createElementBlock$1("view", {
    ...
    createVNode$1(_component_button, {
      "render-whole": true,
      class: normalizeClass$1(["kui-flex kui-leading-none kui-items-center", [_ctx.data.shadowClass]]),
      ...
      default: withCtx$1(() => [
        createElementVNode("view", {
          ...
          _ctx.loading ? (openBlock$1(), createElementBlock$1("view", {
            key: 0,
            class: normalizeClass$1(["kui-relative", [_ctx.content ? "kui-mr-1" : ""]]),
            style: normalizeStyle$1({
              right: `${_ctx.$slots.default ? 10 : 0}rpx`
            })
          }, [
            createCommentVNode$1(' <kui-spin :width="55" :height="55" :type="loadingType" :scale="0.7" :background-color="data.color"></kui-spin> '),
            createVNode$1(_component_kui_icons, {
              color: _ctx.data.color,
              name: "spinner3"
            }, null, 8, ["color"])
          ], 6)) : createCommentVNode$1("v-if", true),
          _ctx.icon ? (openBlock$1(), createElementBlock$1("view", {
            key: 1,
            class: normalizeClass$1(_ctx.$slots.default ? "kui-mr-1" : "")
          }, [
            createCommentVNode$1(' <kui-icons :type="icon" :color="data.color" :weight="800" :size="40"></kui-icons> ')
          ], 2)) : createCommentVNode$1("v-if", true),
          createElementVNode("view", { class: "" }, [
            renderSlot$1(_ctx.$slots, "default", {}, () => [
              ...
              }, toDisplayString$1(_ctx.content), 5)
            ]),
            renderSlot$1(_ctx.$slots, "content")
          ])
        ], 4)
      ]),
      _: 3
...
const KuiButton = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__file", "E:/work/kviewui/src/packages/components/src/button/index.vue"]]);
const spaceProps = {
  justify: {
    type: String,
    default: "flex-start"
...
const KuiSpace = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["styles", [_style_0$1]], ["__file", "E:/work/kviewui/src/packages/components/src/space/index.vue"]]);
const pageProps = {
  bgColor: {
    type: String,
    default: ""
...
const KuiPage = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["styles", [_style_0]], ["__file", "E:/work/kviewui/src/packages/components/src/page/index.vue"]]);
const { create: create$1 } = createComponent("config-provider");
const _sfc_main$2 = create$1({
  ...
  setup(props, { slots, emit: emit2 }) {
    ...
    provide$1(configProviderInjectionKey, config);
    uni.$on("changeMode", (e) => {
      config.mode = e;
      provide$1(configProviderInjectionKey, config);
    });
...
const KuiConfigProvider = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__file", "E:/work/kviewui/src/packages/components/src/config-provider/index.vue"]]);
...
const KuiCellGroup = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "E:/work/kviewui/src/packages/components/src/cell-group/index.vue"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock$1(), createElementBlock$1("scroll-view", {
        ...
        createVNode$1(KuiPage, { customHeader: false }, {
          body: withCtx$1(() => [
            createElementVNode("view", { class: "kui-mt-3" }, [
              createVNode$1(KuiIcons, { name: "pingguo" }),
              createVNode$1(KuiConfigProvider, {
                "font-size": "18px",
                color: "#666"
              }, {
                default: withCtx$1(() => [
                  createElementVNode("view", { class: "kui-flex-col kui-h-full kui-w-full1" }, [
                    createVNode$1(KuiCellGroup, { title: "\u6E10\u53D8\u6309\u94AE" }, {
                      default: withCtx$1(() => [
                        createElementVNode("view", { class: "kui-mt-0" }, [
                          createVNode$1(KuiSpace, { gap: [20, 10] }, {
                            default: withCtx$1(() => [
                              createVNode$1(KuiButton, {
                                content: "\u4E3B\u8981\u6309\u94AE",
                                onClick: taped,
                                type: "primary"
                              }),
                              ...
                              createVNode$1(KuiButton, { content: "\u9ED8\u8BA4\u6309\u94AE" }),
                              createVNode$1(KuiButton, {
                                content: "\u6210\u529F\u6309\u94AE",
                                type: "success"
                              }),
                          ...
                          createVNode$1(KuiSpace, { gap: [20, 10] }, {
                            default: withCtx$1(() => [
                              createVNode$1(KuiButton, {
                                ...
                                default: withCtx$1(() => [
                                  createCommentVNode$1(' <kui-icons name="plus-round" :size="40" /> ')
                                ]),
                                _: 1
                              }),
                              createVNode$1(KuiButton, {
                                ...
                                default: withCtx$1(() => [
                                  createCommentVNode$1(' <kui-icons name="android-alert" :size="50" :top="2" /> ')
                                ]),
                                _: 1
                              }),
                              createVNode$1(KuiButton, {
                                ...
                                default: withCtx$1(() => [
                                  createCommentVNode$1(' <kui-icons name="checkmark-round" :size="40" /> ')
                                ]),
                                _: 1
                              }),
                              createVNode$1(KuiButton, {
                                ...
                                default: withCtx$1(() => [
                                  createCommentVNode$1(' <kui-icons name="alert-circled" :size="50" :top="-3" /> ')
                                ]),
                                _: 1
                              }),
                              createVNode$1(KuiButton, {
                                ...
                                default: withCtx$1(() => [
                                  createCommentVNode$1(' <kui-icons name="close" :size="50" :top="-1" /> ')
                                ]),
                                _: 1
                              })
                            ]),
                    ...
                    createVNode$1(KuiCellGroup, {
                      ...
                      default: withCtx$1(() => [
                        createElementVNode("view", { class: "kui-mt-0" }, [
                          createCommentVNode$1(' <kui-icon name="code" /> '),
                          createCommentVNode$1(' <kui-icon name="right" :size="16" color="#999" :weight="100"></kui-icon> '),
                          createVNode$1(KuiSpace, { gap: [20, 10] }, {
                            default: withCtx$1(() => [
                              createVNode$1(KuiButton, {
                                type: "primary",
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "E:/work/kviewui/src/examples/mobile-uni-cli/src/pages/components/button/index.nvue"]]);
export {
  index as default
};
