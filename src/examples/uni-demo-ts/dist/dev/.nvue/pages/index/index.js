...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "index",
  setup(__props) {
    formatAppLog("log", "at pages/index/index.nvue:18", colorBuilder.generate("#F53F3F", { list: true }));
    formatAppLog("log", "at pages/index/index.nvue:19", colorBuilder.generate("#F53F3F", { index: 10 }));
    formatAppLog("log", "at pages/index/index.nvue:20", colorBuilder.getRgbStr("#00BC79"));
      ...
      return openBlock(), createElementBlock("scroll-view", {
        ...
        createElementVNode("view", { class: "content" }, [
          ...
          createElementVNode("view", { class: "text-area" }, [
            createElementVNode("u-text", { class: "title kui-red-5 kui-bg-green-3 -kui-rotate-45" }, toDisplayString(title.value), 1)
          ])
        ]),
        ...
        createElementVNode("div", { class: "kui-flex kui-inline-flex" }, [
          createElementVNode("div", null, [
            createElementVNode("u-text", null, "111")
          ]),
          createElementVNode("div", { class: "kui-text-base kui-bg-red-2" }, [
            createElementVNode("u-text", null, "222")
          ])
        ])
      ]);
    };
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]], ["__file", "E:/work/kviewui/src/examples/uni-demo-ts/src/pages/index/index.nvue"]]);
export {
  index as default
};
